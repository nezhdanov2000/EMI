...
Число $d_{max} = 7$ обосновано работами по теории визуальных каналов (Munzner, 2014; Ware, 2004): экспериментально установлено, что человек одновременно различает **не более 7–10 независимых кодирований** в одном виде (Healey & Enns, 2012). Использование $d_{max} = 7$ является **консервативной верхней границей**, которая охватывает весь диапазон перцептивно различимых каналов для аналитических задач.
